            ...
            <div className='flex justify-center items-center z-10'>
                <div className='w-80 h-3/4 p-2 bg-white drop-shadow-2xl flex flex-col space-y-4 justify-center items-start'>
                    <div className='space-y-2'>
                        ...
                        <ul className=' text-sm list-disc pl-4 space-y-2'>
                            ...
                            <li>
                                ...
                                <br />
                                Programme de formation aux métiers du cloud et
                                aux technologies DevOps (GCP, Azure, AWS,
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='font-semibold'>
                            Sales Excellence Analyst - Microsoft France
                        </p>
                        <p>Issy Les Moulineaux, France</p>
                        <ul className='text-sm list-disc pl-4 space-y-2'>
                            <li>
                                Analyse et suivi de l’activité Azure en France
                            </li>
                            <li>
                                Analyses ponctuelles en fonction des besoins
                                business : planification, analyse, exécution des
                                initiatives permettant l’efficience des
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='font-semibold'>
                            Stagiaire - Assistante Sales Director, Yoobic France
                        </p>
                        <p>Paris, France</p>
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='font-semibold'>
                            Stagiaire - Resource Manager, Capgemini France
                        </p>
                        <p>Issy Les Moulineaux, France</p>
                        <ul className='text-sm list-disc pl-4 space-y-2'></ul>
                    </div>
